...
?>
<script>
Phx.vista.FuncionarioPla=function(config){//#ETR-1595
	...
	Phx.vista.FuncionarioPla.superclass.constructor.call(this,config);
...
Ext.extend(Phx.vista.FuncionarioPla,Phx.gridInterfaz,{
    ...
    {	
        ...
        Phx.vista.FuncionarioPla.superclass.preparaMenu.call(this);
    },
    liberaMenu:function()
    {	
        ...
        Phx.vista.FuncionarioPla.superclass.liberaMenu.call(this);
    },
