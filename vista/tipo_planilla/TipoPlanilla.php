		...
		
		{
			config:{
				...
				emptyText:'Obtener de...',
	       		...
	       		mode: 'local',
				gwidth: 150,
				store:['parametrizacion','ultimo_activo_periodo','ultimo_activo_gestion','prorrateo_aguinaldo','retroactivo_sueldo','retroactivo_asignaciones']
			},
				type:'ComboBox',
				filters:{	
	       		         type: 'list',
	       				 options: ['parametrizacion','ultimo_activo_periodo','ultimo_activo_gestion','prorrateo_aguinaldo','retroactivo_sueldo','retroactivo_asignaciones'],	
	       		 	},
				id_grupo:1,
				grid:true,
				form:true
