...
ALTER TABLE plani.tobligacion
  ADD CONSTRAINT tobligacion__id_ogligacion_agrupador_fk FOREIGN KEY (id_obligacion_agrupador)
    REFERENCES plani.tobligacion_agrupador(id_obligacion_agrupador)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
    NOT DEFERRABLE;
  ...
  FROM (
         SELECT fp.id_funcionario,
                ...
                fp.id_uo_funcionario, fp.id_funcionario, uofun.fecha_asignacion)
                 ::timestamp without time zone, 'dd/mm/YYYY' ::text) AS
                  fecha_ingreso,
                ...
                (
                  ...
                  WHERE tcolumna_valor.id_funcionario_planilla =
                   fp.id_funcionario_planilla AND
                        tcolumna_valor.codigo_columna::text = 'SUBPRE' ::text
                ) AS subpre,
                (
                  ...
                  WHERE tcolumna_valor.id_funcionario_planilla =
                   fp.id_funcionario_planilla AND
                        (tcolumna_valor.codigo_columna::text = ANY (ARRAY [
                         'SUBSEP' ::character varying::text, 'SUBNAT'
                ...
                (
                  ...
                  WHERE tcolumna_valor.id_funcionario_planilla =
                   fp.id_funcionario_planilla AND
                        tcolumna_valor.codigo_columna::text = 'SUBLAC' ::text
                ) AS sublac,
                (
                  SELECT tcolumna_valor.valor
                  FROM plani.tcolumna_valor
                  WHERE tcolumna_valor.id_funcionario_planilla =
                   fp.id_funcionario_planilla AND
                        tcolumna_valor.codigo_columna::text = 'TOTGAN' ::text
                ) AS total_ganado,
                (
                  SELECT sum(tcolumna_valor.valor) AS sum
                  FROM plani.tcolumna_valor
                   ...
                   fp.id_funcionario_planilla AND
                        (tcolumna_valor.codigo_columna::text = ANY (ARRAY [
                         'TOTGAN' ::character varying::text, 'AFP_PAT'
                          ::character varying::text, 'PREAGUI' ::character
                           varying::text, 'PREPRI' ::character varying::text,
                            'PREVBS' ::character varying::text, 'CAJSAL'
                             ::character varying::text ]))
                ) AS total_gral,
                (
                  SELECT sum(tcolumna_valor.valor) AS sum
                  ...
                  WHERE tcolumna_valor.id_funcionario_planilla =
                   fp.id_funcionario_planilla AND
                        (tcolumna_valor.codigo_columna::text = ANY (ARRAY [
                         'TOT_DESC' ::character varying::text, 'SUBPRE'
                          ::character varying::text, 'SUBLAC' ::character
                           varying::text ]))
                ) AS total_desc,
                (
         ...
         FROM plani.tplanilla plani
              JOIN plani.tfuncionario_planilla fp ON fp.id_planilla =
               plani.id_planilla
              ...
              JOIN orga.tuo_funcionario uofun ON uofun.id_funcionario =
               fun.id_funcionario AND fp.id_uo_funcionario =
                uofun.id_uo_funcionario AND fp.id_funcionario =
         ...
         'cargo' ::text, 'fecha_nacimiento' ::text, 'fecha_ingreso' ::text,
          'subpre' ::text, 'subsep' ::text, 'sublac' ::text, 'total_ganado'
           ::text, 'total_gral' ::text, 'total_desc' ::text, 'codigo_rciva'
            ::text, 'tipo_documento' ::text, 'num_documento' ::text, 'distrito'
             ::text, 'firma' ::text ], ARRAY [ a.nombre_funcionario,
              a.codigo_funcionario, a.codigo_regional::text, a.nivel::text || ''
               ::text, a.cargo::text, a.fecha_nacimiento || '' ::text,
                a.fecha_ingreso || '' ::text, round(a.subpre, 2) || '' ::text,
                 round(a.subsep, 2) || '' ::text, round(a.sublac, 2) || ''
                  ::text, round(a.total_ganado, 2) || '' ::text, round(
                  a.total_gral, 2) || '' ::text, round(a.total_desc, 2) || ''
                   ::text, a.codigo_rciva::text, a.tipo_documento::text,
                    a.num_documento, a.distrito::text,
                     '_____________________________________' ::text ]) u(
...
/***********************************I-DEP-MZM-PLANI-166-01/10/2020****************************************/
...
/***********************************F-DEP-MZM-PLANI-166-01/10/2020****************************************/       
/***********************************I-DEP-MZM-PLANI-1-22/02/2022****************************************/       
...
----
ALTER TABLE planibk.tfuncionario_planilla ADD
...
ALTER TABLE planibk.tfuncionario_planilla ADD    
  CONSTRAINT fk_tfuncionario_planilla__id_cuenta_bancaria FOREIGN KEY (id_cuenta_bancaria)
    ...
    -----
ALTER TABLE planibk.tobligacion_agrupador ADD   
...
ALTER TABLE planibk.tobligacion_agrupador ADD       
  CONSTRAINT tobligacion_agrupador__it_tipo_ob_agr FOREIGN KEY (id_tipo_obligacion_agrupador)
    ...
    ----
    ALTER TABLE planibk.tobligacion ADD   
  ...
  CONSTRAINT tobligacion__id_ogligacion_agrupador_fk FOREIGN KEY (id_obligacion_agrupador)
    ...
    ALTER TABLE planibk.tconsolidado ADD
  ...
  CONSTRAINT fk__tconsolidado__id_presupuesto FOREIGN KEY (id_presupuesto)
    ...
    -----
ALTER TABLE planibk.tconsolidado_columna ADD
...
ALTER TABLE planibk.tconsolidado_columna ADD    
  CONSTRAINT fk_tconsolidado_columna__id_obligacion_det FOREIGN KEY (id_obligacion_det)
    ...
    --------
ALTER TABLE planibk.tdetalle_transferencia ADD        
