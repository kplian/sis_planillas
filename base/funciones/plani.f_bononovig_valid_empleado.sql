...
CREATE OR REPLACE FUNCTION plani.f_bononovig_valid_empleado (
...
$body$
  ...
  ***************************************************************************
   ...
   COMENTARIOS:
   AUTOR:    RAC KPLIAN
   DESCRIP:  funcion para vlaidar personal isnertado directamente en planilla de bono de personal no vigente
   Fecha: 16-04-2020
...
BEGIN
    ...
    v_nombre_funcion = 'plani.f_bononovig_valid_empleado';
