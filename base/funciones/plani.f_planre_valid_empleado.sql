...
CREATE OR REPLACE FUNCTION plani.f_planre_valid_empleado (
...
/**************************************************************************
 ...
 FUNCION:         plani.f_planre_valid_empleado 
...
#25    ETR            01/08/2019              RAC           validacion de empleados registrados
***************************************************************************/
DECLARE
  v_registros			record;
  v_planilla			record;
...
BEGIN
    ...
    v_nombre_funcion = 'plani.f_planre_valid_empleado';
