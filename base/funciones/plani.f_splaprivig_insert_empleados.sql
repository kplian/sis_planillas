...
CREATE OR REPLACE FUNCTION plani.f_splaprivig_insert_empleados(
...
AS $BODY$
 ...
 #145				02.07.2020		Mzambrana	 KPLIAN		Ajuste a funcion por fecha q coincide con la del retiro
 ********************************************************************************/
DECLARE
  v_registros                    record;
  v_planilla                     record;
...
BEGIN
    ...
    v_nombre_funcion = 'plani.f_splaprivig_insert_empleados';
    v_filtro_query = '';
...
ALTER FUNCTION plani.f_splaprivig_insert_empleados(integer)
    OWNER TO postgres;