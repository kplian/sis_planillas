-- FUNCTION: plani.f_prinovig_insert_empleados(integer)

-- DROP FUNCTION plani.f_prinovig_insert_empleados(integer);

CREATE OR REPLACE FUNCTION plani.f_sprinovig_insert_empleados(
...
ALTER FUNCTION plani.f_sprinovig_insert_empleados(integer)
    OWNER TO postgres;
