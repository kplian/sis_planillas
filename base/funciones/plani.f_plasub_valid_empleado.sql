...
BEGIN
    ...
    if (v_existe = 'no') then
    	raise exception 'No se puede añadir el funcionario a la planilla ya que no le corresponde asignación de subsidio por los periodos trabajados en la empresa o ya esta registrado en la planilla';
    end if;
    return;
EXCEPTION
